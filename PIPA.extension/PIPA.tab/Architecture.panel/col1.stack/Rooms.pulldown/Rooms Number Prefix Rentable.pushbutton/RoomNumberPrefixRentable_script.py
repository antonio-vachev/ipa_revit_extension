...
areas=db.Collector(of_category='OST_Areas',where=lambda x: x.get_Parameter(DB.BuiltInParameter.AREA_TYPE).AsValueString() == "Building Common Area").get_elements(wrapped=False) 
