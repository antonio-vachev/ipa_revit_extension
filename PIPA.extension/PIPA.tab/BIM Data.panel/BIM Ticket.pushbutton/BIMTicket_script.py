...
assign_items = ["Anyone", "Radi Karmazov", "Zahari Doychev", "Antonio Vachev","Verginiya Todorova", "Simeon Tachev", "Danail Momchilov", "Daniel Dimitrov", "Sertan Saliev", "Tsvetelina Borisova"]
phase_items = ["N/A", "SD", "DD", "CD", "FS"]
consultant_items = [ "N/A", "AR", "EL", "HVAC", "WS", "ST"]
request_items = ["Modeling Issue", "Family", "Bank Files", "Links", "Master File", "Automations", "File Error", "Visibility Graphics", "Shared Coordinates", "Plugins","Exporting", "Point Clouds", "Specifications", "General Question"]
...
class MyWindow(Windows.Window):
    ...
    def user_id(self):
        ...
        elif self.assign_combobox.Text == "Verginiya Todorova":
            return "588742092965281813"
        elif self.assign_combobox.Text == "Sertan Saliev":
            return "1007244119908814869"
        elif self.assign_combobox.Text == "Tsvetelina Borisova":
            return "1007190453977894962"
        elif self.assign_combobox.Text == "Anyone":
            return "everyone"
    
    @property
    def attachment(self):
        if self.attachment_textbox.Text == "LINK":
            return "N/A"
        else:
